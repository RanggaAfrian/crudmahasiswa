    ...
    <div class="row justify-content-center">
        ...
        <div class=" card-header justify-content-center">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2 ">
							<img src="<?= base_url('assets/images/prodi/') . $prodi['gambar'] ?>" style="width: 100px;"
                    ...
                    <button type="submit" name="update" class="btn btn-primary float right"> Ubah Kaprodi </button>
                </form>
            </div>
        </div>
    </div>
